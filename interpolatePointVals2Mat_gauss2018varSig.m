function [ result ] = interpolatePointVals2Mat_gauss2018varSig( valuematrix, binsX, binsY, sigmaX, sigmaY, threshold, displayVariable )
...
%               in this version, is allowed to be variable with data
